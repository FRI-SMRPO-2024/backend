...
const user_project_controller_1 = require("../controllers/user-project.controller");
 ...
 */
router.post('/get-user-project', jwt_guard_1.jwtGuard, user_project_controller_1.UserProjectController.getUserProject);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/get-project-users/:id', jwt_guard_1.jwtGuard, user_project_controller_1.UserProjectController.getUsersByProject);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/get-user-projects/:id', jwt_guard_1.jwtGuard, user_project_controller_1.UserProjectController.getProjectsByUser);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/add', jwt_guard_1.jwtGuard, user_project_controller_1.UserProjectController.addUserToProject);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete('/remove', jwt_guard_1.jwtGuard, user_project_controller_1.UserProjectController.removeUserFromProject);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.patch('/set-role', jwt_guard_1.jwtGuard, user_project_controller_1.UserProjectController.setUserRoleInProject);
exports.default = router;
//# sourceMappingURL=user-project.routes.js.map