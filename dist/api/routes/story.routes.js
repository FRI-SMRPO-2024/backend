 ...
 */
router.get('/get-all', jwt_guard_1.jwtGuard, story_controller_1.StoryController.getStories);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/get-by-project/:id', jwt_guard_1.jwtGuard, story_controller_1.StoryController.getStoriesByProject);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/get-by-sprint/:id', jwt_guard_1.jwtGuard, story_controller_1.StoryController.getStoriesBySprint);
/**
 * @swagger
 * /api/story/get/{id}:
 *   get:
 ...
 *         description: Internal server error
 */
router.get('/get/:id', jwt_guard_1.jwtGuard, story_controller_1.StoryController.getStory);
/**
 * @swagger
 * /api/story/create:
 *   post:
 ...
 */
router.post('/create', jwt_guard_1.jwtGuard, story_controller_1.StoryController.createStory);
/**
 * @swagger
 * /api/story/update/{id}:
 *   put:
 ...
 */
router.put('/update/:id', jwt_guard_1.jwtGuard, story_controller_1.StoryController.updateStory);
/**
 * @swagger
 * /api/story/delete/{id}:
 *   delete:
 ...
 */
router.delete('/delete/:id', jwt_guard_1.jwtGuard, story_controller_1.StoryController.deleteStory);
