...
router.get('/current/:projectId', jwt_guard_1.jwtGuard, sprint_controller_1.SprintController.getCurrentSprint);
...
router.get('/get-by-project-id/:projectId', jwt_guard_1.jwtGuard, sprint_controller_1.SprintController.getSprints);
...
router.get('/get-by-sprint-id/:id', jwt_guard_1.jwtGuard, sprint_controller_1.SprintController.getSprint);
 ...
 */
// Create sprint route
router.post('/create', jwt_guard_1.jwtGuard, sprint_controller_1.SprintController.createSprint);
 ...
 */
// Update sprint route
router.put('/update/:id', jwt_guard_1.jwtGuard, sprint_controller_1.SprintController.updateSprint);
 ...
 */
// delete sprint route
router.delete('/delete/:id', jwt_guard_1.jwtGuard, sprint_controller_1.SprintController.deleteSprint);
